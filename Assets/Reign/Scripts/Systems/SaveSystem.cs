...
namespace reign
{
    ...
    public class LevelScore
    {
        ...
        public float float_CompletionTime = Mathf.Infinity;
        public LevelScore(string ID, float COMPLETIONTIME)
        {
            string_ID = ID;
            float_CompletionTime = COMPLETIONTIME;
        }
    }
    ...
    {
        public enum enum_GraphicsQuality
        {
            LOW,
            MEDIUM,
            HIGH
        }
        public enum_GraphicsQuality enum_GraphicsQuality_Game = enum_GraphicsQuality.HIGH;
        public int int_MasterVolume = 70;
        public float float_FOV = 80f;
        public ScreenResolution ScreenResolution_Resolution;
        public PostProcessData PostProcessData_PostProcessData;
        public List<LevelScore> List_LevelScores = new();
        public List<KeyBinding> List_InputKeys = new List<KeyBinding>()
        {
            ...
            // Game
            new("Jump", new[]{KeyCode.Space}),
            new("Run", new[]{KeyCode.LeftShift, KeyCode.RightShift}),
            new("Pause", new[]{KeyCode.Escape})
        };
        public GameData()
        {
            int_MasterVolume = 70;
            enum_GraphicsQuality_Game = enum_GraphicsQuality.HIGH;
            ScreenResolution_Resolution = new() { float_Brightness = 1f, int_Width = -1, int_Height = -1, bool_Fullscreen = true, bool_VSync = true, int_Hz = -1 };
            ...
            List_LevelScores = new()
            {
                new("FBH_1", Mathf.Infinity),
            };
        }
    }
...
#pragma warning restore CS0162 // Unreachable code detected
    ...
    public class SaveFileHandler
    {
        ...
        private const string string_PASSWORD = "password_removed";
        private const string string_SALT = "salt_removed";
